...
\begin{center}
    ...
    U.S. Permanent Resident \\ \vspace{1pt}
    \small
    \raisebox{-0.1\height}\ (970) 968-7070 ~
    \href{mailto:fernando.berrospi@icloud.com}{\raisebox{-0.2\height}\  fernando.berrospi@icloud.com} ~ 
...
\section{Experience}
  ...
  \resumeSubheading
  {Jackson Hole Mountain Resort}{Nov. 2024 -- Present}
  {Operations Manager $|$ Microsoft Excel, Microsoft Power BI}{Jackson, WY}
  \resumeItemListStart
    \resumeItem{Implemented data-driven decision-making by analyzing customer feedback and sales trends, achieving a 6\% revenue increase through predictive analysis of seasonal trends.}
    \resumeItem{Automated inventory tracking processes by implementing digital inventory systems with predefined stock thresholds and real-time logging, reducing manual errors and saving 3.5 hours weekly.}
    \resumeItem{Streamlined reporting processes by developing digital dashboards in Power BI that consolidated data from sales and inventory logs into real-time visualizations, cutting reporting time by 35\%}
  \resumeItemListEnd
